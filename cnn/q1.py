...
def getdataset():
    ...
    full_dataset = torchvision.datasets.MNIST(root='./data/mnist', train=True,
    ...
    test_data = torchvision.datasets.MNIST(root='./data/minst', train=False, transform=torchvision.transforms.ToTensor(),
                                           download=True)
...
def main():
    ...
    samples, results = test(net, test_loader)
