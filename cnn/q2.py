...
def getdataset():
    ...
    test_data = torchvision.datasets.FashionMNIST(root='./data/fashionmnist', train=False, transform=torchvision.transforms.ToTensor(),
                                           download=True)
...
def main():
    ...
    samples, results = test(net_f, test_loader)
    print(results)
