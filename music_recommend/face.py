...
import recommendMusicWithMood as re
import surprise
...
class face_emotion():
    ...
    def learning_face(self):
        ...
        while(self.cap.isOpened() and counter < 100):
            ...
            if(len(faces)!=0):
                ...
                cv2.putText(im_rd, 'Analyse your emotion now',(20,50), font, 1, (0, 0, 255), 1, cv2.LINE_AA)
        ...
        nature = emotions['nature']
        sad = emotions['sad']
        happy = emotions['happy']
        amazing = emotions['amazing']


        guess = max(nature,sad,happy,amazing)
        final = ''
        if guess == nature:
            final = 'nature'
        elif guess == sad:
        ...
        cv2.putText(im_rd, 'Guess your emotion is' + final, (20, 500), font, 0.8, (0, 0, 255), 1, cv2.LINE_AA )

        cv2.putText(im_rd, 'give your songs', (20, 500), font, 0.8, (0, 0, 255), 1, cv2.LINE_AA)
        # 释放摄像头
...
if __name__ == "__main__":
    ...
    emotion = my_face.learning_face()
    print('the emotion is '+ emotion + '\n analysing the music list')

    my_model = re.Recommend(emotion)
    print('your emotion is ' + emotion)
    my_model.getPlaylist()
