...
output_image = toimage(input.data)
content_image = toimage(content.data)
style_image = toimage(style.data)
np.savez("outs.npz", input=input_image, content=content_image, style=style_image, output=output_image)
